...
mappendToAppend x y = mappend x y
...
validateInput txt = T.length txt == 0
...
joinTexts a b = mappend a b

-- Get length and compare to zero
hasContent :: Text -> Bool
hasContent t = T.length t > 0
