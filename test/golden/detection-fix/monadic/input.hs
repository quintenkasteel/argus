...
import Control.Monad (liftM, liftM2, mapM, mapM_, forM, forM_, sequence, sequence_, replicateM, ap, join, (>=>))
...
bindReturnFunc f m = m >>= \x -> return (f x)
