...
import Data.List (nub, sort, foldl, elem, (++))
...
checkAny :: [Bool] -> Bool
checkAny xs = any id xs

-- PERFORMANCE ISSUE 18: all id → and
checkAll :: [Bool] -> Bool
checkAll xs = all id xs
